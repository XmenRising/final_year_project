          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/materials" className="text-gray-400 hover:text-green-500">Materials</a></li>
                <li><a href="/support" className="text-gray-400 hover:text-green-500">Support</a></li>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="text-gray-400 hover:text-green-500">YouTube</a>
                <a href="#" className="text-gray-400 hover:text-green-500">TikTok</a>
              </div>
            </div>
          </div>
